...
public class OrderRepository {
    public void insertOrder(String customerPhone,long employeeId,String arrivalDate,String departureDate,double deposit, int facility_id) {
